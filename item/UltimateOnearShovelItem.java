...
import net.mcreator.jiukonmod.procedures.DiggerBoostProcedure;
import net.mcreator.jiukonmod.init.JiukcraftmodModTabs;

import java.util.List;

public class UltimateOnearShovelItem extends ShovelItem {
	public UltimateOnearShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 2327;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		DiggerBoostProcedure.execute(entity);
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("There is no gravel that can resist..."));
	}
