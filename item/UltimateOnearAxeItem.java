...
import net.mcreator.jiukonmod.procedures.LumberjackBoostProcedure;
import net.mcreator.jiukonmod.init.JiukcraftmodModTabs;

import java.util.List;

public class UltimateOnearAxeItem extends AxeItem {
	public UltimateOnearAxeItem() {
		super(new Tier() {
			public int getUses() {
				return 2327;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		LumberjackBoostProcedure.execute(entity);
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("An ax made of pure power"));
		list.add(Component.literal("Trees will be felled madly"));
	}
