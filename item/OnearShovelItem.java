...
import net.mcreator.jiukonmod.procedures.OnearShovelBreakProcedure;
import net.mcreator.jiukonmod.init.JiukcraftmodModTabs;

import java.util.List;

public class OnearShovelItem extends ShovelItem {
	public OnearShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 1842;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Bright and radiant"));
		list.add(Component.literal("bid farewell to the earth!"));
	}

	@Override
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		OnearShovelBreakProcedure.execute();
