...
public class OnearBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final OnearBiomeLeaveDecorator INSTANCE = new OnearBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("onear_biome_tree_leave_decorator", tdt);
	}

	public OnearBiomeLeaveDecorator() {
		super(0.25f);
	}
