...
public class JiuksHouseFeature extends Feature<NoneFeatureConfiguration> {
	public static JiuksHouseFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new JiuksHouseFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("jiukcraftmod:jiuks_house", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("jiukcraftmod:jiuks_house", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public JiuksHouseFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.ROOTED_DIRT, Blocks.STONE, Blocks.SAND);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("jiukcraftmod", "jiuk_house"));
		if (template == null)
			return false;
