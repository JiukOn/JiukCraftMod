...
public class IncompleteOnearPortalFeature extends Feature<NoneFeatureConfiguration> {
	public static IncompleteOnearPortalFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new IncompleteOnearPortalFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("jiukcraftmod:incomplete_onear_portal", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("jiukcraftmod:incomplete_onear_portal", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public IncompleteOnearPortalFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("jiukcraftmod", "incomplete_onearportal"));
		if (template == null)
			return false;
