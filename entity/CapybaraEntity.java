...
public class CapybaraEntity extends TamableAnimal {
	public CapybaraEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JiukcraftmodModEntities.CAPYBARA.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.of(Items.POTATO), true));
		...
		this.goalSelector.addGoal(13, new AvoidEntityGoal<>(this, Monster.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(14, new LookAtPlayerGoal(this, Spider.class, (float) 6));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CapybaraEntity retval = JiukcraftmodModEntities.CAPYBARA.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(JiukcraftmodModEntities.CAPYBARA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
