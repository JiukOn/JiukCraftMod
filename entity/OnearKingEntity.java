...
import net.mcreator.jiukonmod.procedures.OnearKingQuandoAEntidadeMorreProcedure;
import net.mcreator.jiukonmod.procedures.OnearKingAnimationsAttackProcedure;
import net.mcreator.jiukonmod.init.JiukcraftmodModItems;
import net.mcreator.jiukonmod.init.JiukcraftmodModEntities;

public class OnearKingEntity extends PathfinderMob implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(OnearKingEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(OnearKingEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(OnearKingEntity.class, EntityDataSerializers.STRING);
	...
	public OnearKingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JiukcraftmodModEntities.ONEAR_KING.get(), world);
	}

	public OnearKingEntity(EntityType<OnearKingEntity> type, Level world) {
		super(type, world);
		xpReward = 80;
		setNoAi(false);
		setCustomName(Component.literal("JiukOn"));
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "jiuk");
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(JiukcraftmodModItems.KING_CROWN_HELMET.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		OnearKingAnimationsAttackProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	...
	public void die(DamageSource source) {
		super.die(source);
		OnearKingQuandoAEntidadeMorreProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(OnearKingEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
